...
class TestMsgSigntxDecred:
    ...
    def test_purchase_ticket_decred(self, client):
        ...
        out1 = proto.TxOutputType(
            address="TscqTv1he8MZrV321SfRghw7LFBCJDKB3oz",
            amount=199900000,
            script_type=proto.OutputScriptType.SSTXSUBMISSIONPKH,
        )
        out2 = proto.TxOutputType(
            address_n=parse_path("m/44'/1'/0'/0/0"),
            amount=0,
            op_return_data=bytearray.fromhex(
                "dc1a98d791735eb9a8715a2a219c23680edcedad00c2eb0b000000000058"
            ),
            script_type=proto.OutputScriptType.SSTXCOMMITMENTOWNED,
        )
        out3 = proto.TxOutputType(
            address="TsR28UZRprhgQQhzWns2M6cAwchrNVvbYq2",
            amount=0,
            script_type=proto.OutputScriptType.SSTXCHANGE,
        )
        ...
        with client:
            ...
            _, serialized_tx = btc.sign_tx(
                client, "Decred Testnet", [inp1], [out1, out2, out3], prev_txes=TX_API
            )
    ...
    def test_spend_from_stake_generation_and_revocation_decred(self, client):
        inp1 = proto.TxInputType(
            ...
            prev_index=2,
            amount=200000000,
            script_type=proto.InputScriptType.SPENDSSGEN,
            decred_tree=1,
        )
        ...
        inp2 = proto.TxInputType(
            ...
            prev_index=0,
            amount=200000000,
            script_type=proto.InputScriptType.SPENDSSRTX,
            decred_tree=1,
        )
