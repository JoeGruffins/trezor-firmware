...
class TestSignTxDecred(unittest.TestCase):
    ...
    def test_one_one_fee(self):
        ...
        messages = [
            ...
            helpers.UiConfirmOutput(out1, coin_decred),
            True,
    ...
    def test_purchase_ticket(self):
        ...
        out1 = TxOutput(
            address="DsaHnKa418BeeQmyhpQEGG4cxGAPrneydfv",
            amount=390000 - 10000,
            script_type=OutputScriptType.SSTXSUBMISSIONPKH,
            multisig=None,
        )
        out2 = TxOutput(
            address_n=[44 | 0x80000000, 42 | 0x80000000, 0 | 0x80000000, 0, 0],
            amount=0,
            op_return_data=unhexlify(
                "762e46655536d93ad13f88a49bde9a2df45fe62e70f30500000000000058"
            ),
            script_type=OutputScriptType.SSTXCOMMITMENTOWNED,
            multisig=None,
        )
        out3 = TxOutput(
            address="DsQxuVRvS4eaJ42dhQEsCXauMWjvopWgrVg",
            amount=0,
            script_type=OutputScriptType.SSTXCHANGE,
            multisig=None,
        )
        tx = SignTx(
            coin_name="Decred", version=1, lock_time=0, inputs_count=1, outputs_count=3
        )
